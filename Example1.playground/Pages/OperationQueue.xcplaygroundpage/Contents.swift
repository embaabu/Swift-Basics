...
//: [Next](@next)
//Operation and OperationQueue -- it is a wrapper build on top of GCD, it gives moe control like we can pause, start, stop, resume and monitor tast as well
...
task3.addDependency(task2) //task 1 will wait for 2 to finish
task2.addDependency(task1) // task 2 will wait for 3 to finish
//order will be 3->2->1
