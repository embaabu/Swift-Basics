...
//Generics -- this allows you to write code that works with any data types by defining its place holderwhich can contain any data type insted of specific one
